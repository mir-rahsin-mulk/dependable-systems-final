...
The examples here are to generate one set of data. Remember to delete the output folders after each time_execution run because faults are injected inside that bash script.
